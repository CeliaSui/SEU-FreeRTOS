 ...
 * https://github.com/espressif/esp-idf/tree/12b2268ee56dac79988b75dbb49a453629ed8022/examples/system/esp_timer 
 */
...
void app_main()
{
    ...
    const esp_timer_create_args_t oneshot_timer_args = {
            ...
            .arg = (void*) periodic_timer,         /* argument will be passed to timer callback function */
            .name = "one-shot"
    };
    ...
    /* Timekeeping continues in light sleep, and timers are scheduled correctly after light sleep.  */
